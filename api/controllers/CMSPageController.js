...
class CMSPageController {
    ...
    async createCmspage(req, res) {
        ...
        if (cmsPageSameSlug)
            return {
                error: 'CMS Page with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        let cmspage;
        try {
            cmspage = await CMSPageService.createCmspage(
                parent_page,
                title,
                slug,
                short_description,
            ...
            return {
                message: 'Error creating CMS Page, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully created CMS Page!',
            cmspage,
            statusCode: 200,
        };
    }
    ...
    async editCmspage(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a cmspage ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid cmspage ID',
                statusCode: 400,
            };
        ...
        let cmsPageSameSlug = await CMSPageService.getCmspageWithSlug(slug);
        if (cmsPageSameSlug && cmsPageSameSlug.id != cmspage.id)
            return {
                error: 'Cmspage with that slug already exists',
                statusCode: 400,
            };

        cmspage = null;
        try {
            cmspage = await CMSPageService.editCmspage(
                id,
                parent_page,
                title,
                slug,
            ...
            return {
                message: 'Error editing CMS Page, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited CMS Page!',
            cmspage,
            statusCode: 200,
        };
    }
    ...
    async deleteCmspage(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting cmspage, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllCmspage(req, res) {
        ...
        let cmspages = await CMSPageService.getCmspages(
            limit,
            page,
            language_id,
            is_active
        ...
        let cmspagesCount = await CMSPageService.getCmspagesCount(
            language_id,
            is_active
        );
    ...
    async getCmspage(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a CMS Page ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid CMS Page ID',
                statusCode: 400,
            };
    ...
    async getCmspageWithSlug(req, res) {
        ...
        if (!slug)
            return { error: 'Please provide a CMS Page Slug', statusCode: 400 };
