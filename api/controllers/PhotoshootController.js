...
class PhotoshootsController {
    ...
    async createPhotoshoot(req, res) {
        ...
        let photoshootSameSlug = await PhotoshootsService.getPhotoshootWithSlug(
            slug
        );
        if (photoshootSameSlug)
            return {
                error: 'Photoshoot with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        let photoshoot;
        try {
            photoshoot = await PhotoshootsService.createPhotoshoot(
                title,
                slug,
                description,
                banner_image,
            ...
            return {
                message: 'Error creating photoshoot, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully created Photoshoot!',
            photoshoot,
            statusCode: 200,
        };
    }
    ...
    async editPhotoshoot(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a photoshoot ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid photoshoot ID',
                statusCode: 400,
            };
        ...
        if (!photoshoot)
            return { error: 'Photoshoot not found', statusCode: 404 };
        ...
        if (photoshootSameSlug && photoshootSameSlug.id != id)
            return {
                error: 'Photoshoot with that slug already exists, please choose another slug',
                statusCode: 400,
            };
        ...
        photoshoot = null;
        try {
            photoshoot = await PhotoshootsService.editPhotoshoot(
                id,
                title,
                slug,
                description,
            ...
            return {
                message: 'Error editing photoshoot, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Photoshoot!',
            photoshoot,
            statusCode: 200,
        };
    }
    ...
    async deletePhotoshoot(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting photoshoot, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllPhotoshoot(req, res) {
        ...
        if (!limit) limit = 50;
        let photoshoots = await PhotoshootsService.getPhotoshoots(
            limit,
            page,
            language_id,
            is_active
        ...
        let photoshootsCount = await PhotoshootsService.getPhotoshootsCount(
            language_id,
            is_active
        );
    ...
    async getPhotoshootWithSlug(req, res) {
        ...
        if (!slug)
            return {
                error: 'Please provide a photoshoot slug',
                statusCode: 400,
            };
    ...
    async createPhotoshootImage(req, res) {
        ...
        if (!photoshoot_id || !caption || !is_active || !language_id)
            return { error: 'Please fill out all fields', statusCode: 400 };
        ...
        let image;
        try {
            image = await PhotoshootsService.createPhotoshootImage(
                photoshoot_id,
                image_name,
                caption,
                language_id,
            ...
            return {
                message: 'Error adding event image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully added Photoshoot Image!',
            image,
            statusCode: 200,
        };
    }
    ...
    async getAllPhotoshootImages(req, res) {
        let { photoshoot_id } = req.params;
        let images = await PhotoshootsService.getPhotoshootImages(
            photoshoot_id
        );
    ...
    async editPhotoshootImageStatus(req, res) {
        ...
        if (!image)
            return { error: 'Photoshoot image not found', statusCode: 404 };

        try {
            await PhotoshootsService.editPhotoshootImageStatus(id, is_active);
        } catch (error) {
            return {
                message: 'Error deleting event image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
