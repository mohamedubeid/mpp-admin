...
class SlidersController {
    ...
    async createSlider(req, res) {
        ...
        let slider;
        try {
            slider = await SlidersService.createSlider(
                title,
                short_description,
                description,
                link,
            ...
            return {
                message: 'Error creating slider, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async editSlider(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a slider ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid slider ID',
                statusCode: 400,
            };
        ...
        slider = null;
        try {
            slider = await SlidersService.editSlider(
                id,
                title,
                short_description,
                description,
            ...
            return {
                message: 'Error editing slider, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Slider!',
            slider,
            statusCode: 200,
        };
    }
    ...
    async deleteSlider(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting slider, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllSlider(req, res) {
        ...
        let sliders = await SlidersService.getSliders(
            limit,
            page,
            language_id,
            is_active
        ...
        let slidersCount = await SlidersService.getSlidersCount(
            language_id,
            is_active
        );
