...
class LifestyleController {
    ...
    async createLifestyle(req, res) {
        ...
        let lifestyleSameSlug = await LifestylesService.getLifestyleWithSlug(
            slug
        );
        if (lifestyleSameSlug)
            return {
                error: 'Lifestyle with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        let lifestyle;
        try {
            lifestyle = await LifestylesService.createLifestyle(
                title,
                slug,
                description,
                banner_image,
            ...
            return {
                message: 'Error creating lifestyle, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully created Lifestyle!',
            lifestyle,
            statusCode: 200,
        };
    }
    ...
    async editLifestyle(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a lifestyle ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid lifestyle ID',
                statusCode: 400,
            };
        ...
        if (!lifestyle)
            return { error: 'Lifestyle not found', statusCode: 404 };
        ...
        if (lifestyleSameSlug && lifestyleSameSlug.id != id)
            return {
                error: 'Lifestyle with that slug already exists, please choose another slug',
                statusCode: 400,
            };
        ...
        lifestyle = null;
        try {
            lifestyle = await LifestylesService.editLifestyle(
                id,
                title,
                slug,
                description,
            ...
            return {
                message: 'Error editing lifestyle, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Lifestyle!',
            lifestyle,
            statusCode: 200,
        };
    }
    ...
    async deleteLifestyle(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting lifestyle, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllLifestyle(req, res) {
        ...
        if (!limit) limit = 50;
        let lifestyles = await LifestylesService.getLifestyles(
            limit,
            page,
            language_id,
            is_active
        ...
        let lifestlesCount = await LifestylesService.getLifestyleCount(
            language_id,
            is_active
        );
    ...
    async getLifestyleWithSlug(req, res) {
        ...
        if (!slug)
            return {
                error: 'Please provide a lifestyle slug',
                statusCode: 400,
            };
    ...
    async createLifestyleImage(req, res) {
        ...
        if (!lifestyle_id || !caption || !is_active || !language_id)
            return { error: 'Please fill out all fields', statusCode: 400 };
        ...
        let image;
        try {
            image = await LifestylesService.createLifestyleImage(
                lifestyle_id,
                image_name,
                caption,
                language_id,
            ...
            return {
                message: 'Error adding lifestyle image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully added Lifestyle Image!',
            image,
            statusCode: 200,
        };
    }
    ...
    async editLifestyleImageStatus(req, res) {
        ...
        if (!id)
            return {
                error: 'Please provide a lifestyle image ID',
                statusCode: 400,
            };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid lifestyle image ID',
                statusCode: 400,
            };
        ...
        if (!image)
            return { error: 'Lifestyle image not found', statusCode: 404 };
        ...
        try {
            ...
            return {
                message:
                    'Error editing lifestyle image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async deleteLifestyleImage(req, res) {
        ...
        try {
            ...
            return {
                message:
                    'Error deleting lifestyle image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
