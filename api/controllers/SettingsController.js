...
class SettingController {
    ...
    async createSetting(req, res) {
        ...
        if (!setting_title || !setting_value || !language_id)
            return { error: 'Please fill out all fields', statusCode: 400 };

        // getSettingFromTitle
        let settingSameTitle = await SettingsService.getSettingFromTitle(
            setting_title
        );
        if (settingSameTitle)
            return {
                error: 'Setting with that title already exists',
                statusCode: 400,
            };
        ...
        try {
            ...
            return {
                message: 'Error creating setting, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async editSetting(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a setting ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid setting ID',
                statusCode: 400,
            };
        ...
        if (settingSameTitle && settingSameTitle.id != id)
            return {
                error: 'Setting with that title already exists',
                statusCode: 400,
            };
        ...
        setting = null;
        try {
            setting = await SettingsService.editSetting(
                id,
                setting_title,
                setting_value,
                language_id,
            ...
            return {
                message: 'Error editing setting, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Setting!',
            setting,
            statusCode: 200,
        };
    }
    ...
    async deleteSetting(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting setting, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllSetting(req, res) {
        ...
        let settingsCount = await SettingsService.getSettingsCount(
            language_id,
            is_active
        );
    ...
    async getSettingFromTitle(req, res) {
        ...
        if (!title)
            return { error: 'Please provide a setting title', statusCode: 400 };
