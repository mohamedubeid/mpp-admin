...
class MagazinesController {
    ...
    async createMagazine(req, res) {
        ...
        if (magazineSameSlug)
            return {
                error: 'Magazine with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        let magazine;
        try {
            magazine = await MagazinesService.createMagazine(
                title,
                slug,
                description,
                banner_image,
            ...
            return {
                message: 'Error creating magazine, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully created Magazine!',
            magazine,
            statusCode: 200,
        };
    }
    ...
    async editMagazine(req, res) {
        ...
        if (!id)
            return { error: 'Please provide a magazine ID', statusCode: 400 };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid magazine ID',
                statusCode: 400,
            };
        ...
        let magazineSameSlug = await MagazinesService.getMagazineWithSlug(slug);
        if (magazineSameSlug && magazineSameSlug.id != id)
            return {
                error: 'Magazine with that slug already exists, please choose another slug',
                statusCode: 400,
            };
        ...
        magazine = null;
        try {
            magazine = await MagazinesService.editMagazine(
                id,
                title,
                slug,
                description,
            ...
            return {
                message: 'Error editing magazine, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Magazine!',
            magazine,
            statusCode: 200,
        };
    }
    ...
    async deleteMagazine(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting magazine, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllMagazine(req, res) {
        ...
        let magazines = await MagazinesService.getMagazines(
            limit,
            page,
            language_id,
            is_active
        ...
        let magazinesCount = await MagazinesService.getMagazinesCount(
            language_id,
            is_active
        );
    ...
    async getMagazineWithSlug(req, res) {
        ...
        if (!slug)
            return { error: 'Please provide a magazine slug', statusCode: 400 };
    ...
    async createMagazineImage(req, res) {
        ...
        if (!magazine_id || !caption || !is_active || !language_id)
            return { error: 'Please fill out all fields', statusCode: 400 };
        ...
        let image;
        try {
            image = await MagazinesService.createMagazineImage(
                magazine_id,
                image_name,
                caption,
                language_id,
            ...
            return {
                message: 'Error adding magazine image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully added Magazine Image!',
            image,
            statusCode: 200,
        };
    }
    ...
    async editMagazineImageStatus(req, res) {
        ...
        if (!image)
            return { error: 'Magazine image not found', statusCode: 404 };
        ...
        try {
            ...
            return {
                message:
                    'Error deleting magazine image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
