...
class PiecesController {
    ...
    async createPiece(req, res) {
        ...
        let piece;
        try {
            piece = await PiecesService.createPiece(
                title,
                banner_image,
                is_active,
                user.id
            ...
            return {
                message: 'Error creating piece, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully created piece!',
            piece,
            statusCode: 200,
        };
    }
    ...
    async editPiece(req, res) {
        ...
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid piece ID',
                statusCode: 400,
            };
        ...
        piece = null;
        try {
            piece = await PiecesService.editPiece(
                id,
                title,
                banner_image,
                is_active,
            ...
            return {
                message: 'Error editing piece, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited piece!',
            piece,
            statusCode: 200,
        };
    }
    ...
    async deletePiece(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting piece, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllPieces(req, res) {
        ...
        const pieces = await PiecesService.getPieces(
            limit,
            page,
            language_id,
            is_active
        ...
        let piecesCount = await PiecesService.getPiecesCount(
            language_id,
            is_active
        );
    ...
    async getPieceWithSlug(req, res) {
        ...
        if (!slug)
            return { error: 'Please provide a piece slug', statusCode: 400 };
