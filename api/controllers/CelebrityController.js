...
class CelebrityController {
    ...
    async createCategory(req, res) {
        ...
        if (categorySameSlug)
            return {
                error: 'Category with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        if (!parent_page) parent_page = 0;

        let categories = await CelebrityService.getCategories(
            null,
            1,
            null,
            'all'
        ...
        let category;
        try {
            category = await CelebrityService.createCategory(
                parent_page,
                title,
                slug,
                description,
        ...
        return {
            message: 'Successfully created Celebrity Category!',
            category,
            statusCode: 200,
        };
    }
    ...
    async editCategory(req, res) {
        ...
        if (categorySameSlug && categorySameSlug.id != id)
            return {
                error: 'Post with that slug already exists, please choose another slug',
                statusCode: 400,
            };

        category = null;
        try {
            category = await CelebrityService.editCategory(
                id,
                parent_page,
                title,
                slug,
        ...
        return {
            message: 'Successfully edited Celebrity Category!',
            category,
            statusCode: 200,
        };
    }
    ...
    async getAllCategories(req, res) {
        ...
        let categoriesCount = await CelebrityService.getCategoriesCount(
            language_id,
            is_active
        );
    ...
    async createPost(req, res) {
        ...
        let post;
        try {
            post = await CelebrityService.createPost(
                title,
                slug,
                description,
                short_description,
        ...
        return {
            message: 'Successfully created Celebrity Post!',
            post,
            statusCode: 200,
        };
    }
    ...
    async editPost(req, res) {
        ...
        post = null;
        try {
            post = await CelebrityService.editPost(
                id,
                title,
                description,
                slug,
        ...
        return {
            message: 'Successfully edited Celebrity Post!',
            post,
            statusCode: 200,
        };
    }
    ...
    async getAllPosts(req, res) {
        ...
        let posts = await CelebrityService.getPosts(
            limit,
            page,
            language_id,
            categoryIDs,
        ...
        let postsCount = await CelebrityService.getPostsCount(
            language_id,
            categoryIDs,
            is_active
        );
    ...
    async createPostImage(req, res) {
        ...
        let image;
        try {
            image = await CelebrityService.createPostImage(
                post_id,
                image_name,
                caption,
                language_id,
        ...
        return {
            message: 'Successfully added Celebrity Image!',
            image,
            statusCode: 200,
        };
    }
    ...
    async editPostImageStatus(req, res) {
        ...
        if (!id)
            return {
                error: 'Please provide a celebrity image ID',
                statusCode: 400,
            };
        if (typeof id !== 'number')
            return {
                error: 'Please provide a valid celebrity image ID',
                statusCode: 400,
            };
        ...
        if (!image)
            return { error: 'Celebrity image not found', statusCode: 404 };
        ...
        try {
            ...
            return {
                message:
                    'Error editing celebrity image, please try again later',
                err: error,
                statusCode: 500,
            };
        }
