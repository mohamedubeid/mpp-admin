...
class TvController {
    ...
    async createCategory(req, res) {
        ...
        let category;
        try {
            category = await TvService.createCategory(
                title,
                description,
                slug,
                meta_title,
        ...
        return {
            message: 'Successfully created Tv Category!',
            category,
            statusCode: 200,
        };
    }
    ...
    async editCategory(req, res) {
        ...
        category = null;
        try {
            category = await TvService.editCategory(
                id,
                title,
                description,
                slug,
        ...
        return {
            message: 'Successfully edited Tv Category!',
            category,
            statusCode: 200,
        };
    }
    ...
    async getAllCategories(req, res) {
        ...
        let categories = await TvService.getCategories(
            limit,
            page,
            language_id,
            is_active
        ...
        let categoriesCount = await TvService.getCategoriesCount(
            language_id,
            is_active
        );
    ...
    async createVideo(req, res) {
        ...
        if (!req.files)
            return {
                error: 'Please upload a video and a banner image',
                statusCode: 400,
            };
        ...
        let video;
        try {
            video = await TvService.createVideo(
                title,
                video_file,
                slug,
                banner_image,
            ...
            return {
                message: 'Error creating video, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        if (categories && categories.length > 0) {
            ...
            try {
                ...
                return {
                    message:
                        'Error creating video categories, please try again later',
                    err: error,
                    statusCode: 500,
                };
            }
        ...
        return {
            message: 'Successfully created Tv Video!',
            video,
            statusCode: 200,
        };
    }
    ...
    async editVideo(req, res) {
        ...
        let videoSameSlug = await TvService.getVideoWithSlug(slug);
        if (videoSameSlug && videoSameSlug.id != id)
            return {
                error: 'Video with that slug already exists, please choose another slug',
                statusCode: 400,
            };
        ...
        video = null;
        try {
            video = await TvService.editVideo(
                id,
                formattedCategories,
                title,
                video_file,
            ...
            return {
                message: 'Error editing video, please try again later',
                err: error,
                statusCode: 500,
            };
        }
        ...
        return {
            message: 'Successfully edited Tv Video!',
            video,
            statusCode: 200,
        };
    }
    ...
    async deleteVideo(req, res) {
        ...
        try {
            ...
            return {
                message: 'Error deleting video, please try again later',
                err: error,
                statusCode: 500,
            };
        }
    ...
    async getAllVideos(req, res) {
        ...
        let videos = await TvService.getVideos(
            limit,
            page,
            language_id,
            categoryIDs,
        ...
        let videosCount = await TvService.getVideosCount(
            language_id,
            categoryIDs,
            is_active
        );
    ...
    async getVideoWithSlug(req, res) {
        ...
        if (!slug)
            return { error: 'Please provide a video slug', statusCode: 400 };
    ...
    async getVideoCategories(req, res) {
        ...
        if (!video_id)
            return { error: 'Please provide a video ID', statusCode: 400 };
