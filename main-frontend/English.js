...
class English {
    async Index(req, res) {
        ...
        let [
            ...
            CelebrityController.getAllSelectedPosts(req, res),
    ...
    async Lifestyle(req, res) {
        ...
        let lifestylePosts = await LifestyleController.getAllLifestyle(
            req,
            res
        );
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeLifestylePosts = await (
            await LifestyleController.getAllLifestyle(req, res)
        ).lifestyles;
    ...
    async Events(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeEventPosts = await (
            await EventsController.getAllEvent(req, res)
        ).events;
    ...
    async Watches(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeWatchPosts = await (
            await WatchController.getAllPosts(req, res)
        ).posts;
    ...
    async Jewelry(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeJewelryPosts = await (
            await JewelryController.getAllPosts(req, res)
        ).posts;
    ...
    async Celebrities(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeCelebrityPosts = await (
            await CelebrityController.getAllPosts(req, res)
        ).posts;

        let categories = await (
            await CelebrityController.getAllCategories(req, res)
        ).categories;
    ...
    async TV(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeTVPosts = await (
            await TvController.getAllVideos(req, res)
        ).videos;
    ...
    async News(req, res) {
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreeNewsPosts = await (
            await NewsController.getAllPosts(req, res)
        ).posts;
    ...
    async Photoshoot(req, res) {
        ...
        let photoshootPosts = await PhotoshootController.getAllPhotoshoot(
            req,
            res
        );
        ...
        req.query.limit = 3;
        req.query.page = 1;
        let firstThreePhotoshootPosts = await (
            await PhotoshootController.getAllPhotoshoot(req, res)
        ).photoshoots;
    ...
    async Subscribe(req, res) {
        ...
        if (data.statusCode == 200) {
            res.redirect(
                redirectURL +
                    '?success=Successfully signed you up in the Newsletter!'
            );
            return;
        }
        res.redirect(
            redirectURL +
                '?error=Failed to sign you up to the Newletter! Please try again later'
        );
        return;
    }
}
